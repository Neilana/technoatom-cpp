...
# Задание 4
1. - [ ] Реализовать типобезопасный printf с помощью variadic templates.

# Задание 5
1. - [ ] auto_ptr.
2. - [ ] shared_ptr.
3. - [ ] unique_ptr.
4. - [ ] Пример падения программы при использовании auto_ptr.
5. - [ ] Реализовать класс Exceptions.
6. - [ ] Демонстрация использования класса Exceptions в main.
