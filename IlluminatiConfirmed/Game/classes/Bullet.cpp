...
IlluminatiConfirmed::experimental::Bullet::Bullet(b2World *world, sf::Texture *texture, IlluminatiConfirmed::experimental::BulletInfo &&info)
    : BaseInterface(TypeBase::BULLET), m_b2_center(nullptr) {
    LOG() << "Create bullet \n";
    {
        b2BodyDef bd;
        bd.fixedRotation = false;  //можно сделать центр не сталкивающимся с чем
...
void IlluminatiConfirmed::experimental::Bullet::setTransform(IlluminatiConfirmed::experimental::BulletSets &&sets) {
...
void IlluminatiConfirmed::experimental::Bullet::move(b2Vec2 velocity, float deltaTime) {
    static float m_time;
    static int dir = 1;
